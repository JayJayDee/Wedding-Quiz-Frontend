...
<template>
  <v-layout column="1">    
    <v-card block>
      ...
      <v-card-text>
        <p class="text-sm-left text-left">모든 퀴즈를 다 푸셨습니다. 결과를 확인해 보세요!</p>
        <p class="text-sm-left text-left">이번 기록을 무시하고 재도전 하실수도 있습니다.</p>
      </v-card-text>
      <v-card-actions>
        <v-btn color="primary" flat>전체 순위 보기</v-btn>
        <v-btn color="warning" flat>기록을 무시하고 재도전!</v-btn>
      </v-card-actions>
    </v-card>
  </v-layout>
</template>
